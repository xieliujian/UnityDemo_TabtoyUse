...
def export_cshapemgrfile(file_root_path):
    ...
    filecontent += "using gtmInterface;\n"
    filecontent += "using System.IO;\n"
    filecontent += "using tabtoy;\n\n"

    filecontent += "namespace gtmGame\n"
    filecontent += "{\n"
    filecontent += "    public class ConfigManager : IConfigManager\n"
    filecontent += "    {\n"

    for file in filelist:
        filecontent += "        public " + file + "Cfg " + file.lower() + "cfg = new " + file + "Cfg();\n\n"

    filecontent += "        public override void DoInit()\n"
    filecontent += "        {\n"
    for file in filelist:
        filecontent += "            Init" + file + "Cfg();\n"
    filecontent += "        }\n\n"

    filecontent += "        public override void DoClose()\n"
    filecontent += "        {\n"
    filecontent += "        }\n\n"

    filecontent += "        public override void DoUpdate()\n"
    filecontent += "        {\n"
    filecontent += "        }\n\n"
    ...
    for file in filelist:
        ...
        filecontent += "            byte[] bytes = IResourceLoad.instance.LoadResourceSync(\"config/table/\", \"" + file.lower() + \
            "\" , \".bytes\", IResourceType.Bytes) as byte[];\n"
        ...
        filecontent += "            {\n"
        filecontent += "                ILogSystem.instance.LogError(LogCategory.GameLogic, \"" + file.lower() + \
